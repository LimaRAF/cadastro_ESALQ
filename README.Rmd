...
Launch the [`make.R`](https://github.com/LimaRAF/cadastro_ESALQ/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/LimaRAF/cadastro_ESALQ/blob/main/CONTRIBUTING.md).
